...
sud.ouest <-  house %>%
  filter((min(house$lat)<house$lat | house$long<milieu.lat) & (min(house$long)<house$long | house$long<milieu.long))

sud.est <-  house %>%
  filter((min(house$lat)<house$lat | house$long<milieu.lat) & (milieu.long<house$long | house$long<max(house$long)))

nord.est <- house %>%
  filter((milieu.lat<house$lat | house$lat<max(house$lat)) & (milieu.long<house$long | house$long<max(house$long)))

nord.ouest <- house %>%
  filter(((milieu.lat<house$lat | house$lat<max(house$lat)) & (min.long<house$long | house$long<milieu.long)))
