...
milieu.long = (max(house$lat)-min(house$lat))/2
...
# Autre approche de présentation des différentes zones géographiques.

library(dplyr)
library(ggplot2)


#  Appliquons un clustering k-means pour définir 10 zones
...
p <- ggplot(house_clean, aes(x = long, y = lat, color = zone), text = paste("Zone:", zone)) +
